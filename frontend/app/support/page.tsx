      ...
      <Container maxW="container.md">
        <VStack spacing={6} align="stretch">
          ...
          <Box>
            ...
            <Text mb={4}>
              Simply enter a Polygon wallet address to view its activity and
              token balances. All data is fetched directly from the blockchain —
            ...
            <Text mb={4}>
              Absolutely! POCKET MONEY is open-source. You can clone the
              repository, customize the interface, or deploy it privately. Check
              our GitHub for setup instructions.
            </Text>
          </Box>
          ...
          <Box>
            ...
            <Text>
              We welcome feedback, ideas, and contributions! If you’d like to
              report an issue, request a feature, or submit a pull request, head
              to our GitHub repo.
            </Text>
            <UnorderedList spacing={2} mt={2}>
              <ListItem>
                ...
                <Text as="span" color="blue.400">
                  github.com/mindsgn/pocket-money
                </Text>
              </ListItem>
              <ListItem>
          ...
          <Box pt={4}>
            <Text color="gray.400" fontSize="sm">
              POCKET MONEY is maintained by the community. We appreciate your

      ...
      <div className="space-y-6">
        ...
        <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
          <div className="text-sm">
            <div className="font-medium text-purple-900">{}</div>
  ...
  return (
    <form onSubmit={handleEmailSubmit} className="space-y-6">
      ...
      <Button
        title="btn-submit"
        type="submit"
        className="w-full h-12 bg-gradient-to-r from-orange-500 to-pink-500 hover:from-pink-500 hover:to-orange-500"
        disabled={isLoading}
      >
        {isLoading ? (
          <>

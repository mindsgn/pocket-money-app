...
<head>
  ...
  <title>Vibe Connect - Verification Code</title>
  <style>
    /* Reset styles */
    * {
      margin: 0;
    ...
    <div class="email-container">
      ...
      <div class="header">
        <div class="logo">
          ...
          <div class="logo-text">Vibe Connect</div>
        </div>
      ...
      <div class="content">
        ...
        <div class="message">
          We received a request to sign in to your Vibe Connect account. To complete the process, please use the verification code below or click the verification button.
        </div>
      ...
      <div class="footer">
        <div class="footer-text">
          This email was sent by Vibe Connect. If you have any questions, we're here to help.
        </div>
        
        <div class="footer-links">
          <a href="https://Vibe Connect.xyz/help" class="footer-link">Help Center</a>
          <a href="https://Vibe Connect.xyz/privacy" class="footer-link">Privacy Policy</a>
          <a href="https://Vibe Connect.xyz/terms" class="footer-link">Terms of Service</a>
        </div>
        
        <div class="footer-copyright">
          © ${new Date().getFullYear()} Vibe Connect. All rights reserved.
        </div>
      </div>
    </div>
  </div>
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Welcome to Vibe Connect</title>
  <style>
  ...
  <div style="background-color: #f9fafb; padding: 20px 0;">
    <div class="email-container">
      <div class="header">
        ...
        <h1 class="header-title">Welcome to Vibe Connect! 🎉</h1>
      </div>
      
      <div class="content">
        <div class="welcome-message">
          Hi ${userName}! We're thrilled to have you join the Vibe Connect community.
        </div>
        ...
        <div class="cta-section">
          ...
          <a href="https://app.Vibe Connect.xyz/onboarding" class="cta-button">
            Complete Setup →
          </a>
        </div>
      </div>
...
export function createLoyaltyPointsEmailTemplate({
  userName = "there",
  pointsEarned = 0,
  redemptionLink = "https://app.Vibe Connect.xyz/rewards"
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Your Loyalty Points Update - Vibe Connect</title>
  <style>
    ...
    <div class="email-container">
      ...
      <div class="content">
        ...
        <p style="font-size: 16px; color: #374151; margin-bottom: 24px;">
          Great news! You've just earned **${pointsEarned} loyalty points** with Vibe Connect!
        ...
        <p style="font-size: 14px; color: #6b7280; text-align: center; margin-top: 32px;">
          Thank you for being a valued member of the Vibe Connect community!
        </p>
      </div>
      ...
      <div class="footer">
        ...
        <p>
          <a href="https://Vibe Connect.xyz/privacy" style="color: #2563eb;">Privacy Policy</a> |
          <a href="https://Vibe Connect.xyz/terms" style="color: #2563eb;">Terms of Service</a>
        </p>
      </div>
    </div>
  </div>
